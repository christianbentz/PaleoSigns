...
This repository contains data and code to work on the statistical properties of Upper Paleolithic geometric signs of the Swabian Aurignacian. The relevant primary article is: Bentz and Dutkiewicz (2025). Ancient humans of 40 000 years ago communicated with a system of visual signs. 
...
## Secondary Analyses
- analyses_chineseCharsStrokes.Rmd: Comparison of feature distributions between Mandarin Chinese lines written in Han simplified characters as well as counting individual strokes per character.
