...
```
# Description
This file enables post-hoc analyses of the performance values (accuracy, F1-scores, p-values) of the KNN and MLP classifications. It provides density distributions for these performance metrics. 
...
```{r}
# map p-values to either 0 or 1 with the alpha criterion
