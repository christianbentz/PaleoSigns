...
```{r}
f1.plot <- ggplot(performance.mlp.combined, aes(x = jitter(f1, amount = 0.05), 
...
## Combine Plots
```{r}
combined.plot <- grid.arrange(f1.plot, accuracy.plot, pvalue.plot, ncol = 3, widths = c(1.2, 0.8, 0.8))
```
