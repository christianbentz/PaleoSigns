...
# Baseline
We here compute a performance baseline by simply predicting the most frequent label for all items in the test set.
```{r}
...
Safe label predictions of the last run alongside the other columns in the test data set.
```{r}
...
write.csv(results.df, file = paste(c("~/Github/UpperPalCombinatorics/results/classifier/MLP/results_MLP_",
                                              act.fct.name, "_",
                                              err.fct, "_",
                                              algorithm, "_",
                                              subcorpus1, "_",
                                      ...
                                      row.names = F)
# predictions for post-hoc analyses
write.csv(mlp.predictions.df, file = paste(c("~/Github/UpperPalCombinatorics/results/classifier/MLP/predictions_MLP_",
                                              act.fct.name, "_",
                                              err.fct, "_",
                                              algorithm, "_",
                                              subcorpus1, "_",
