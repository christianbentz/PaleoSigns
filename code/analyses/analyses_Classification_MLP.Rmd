...
for (hidden in hidden.list) {
  ...
  write.csv(mlp.predictions.df, file = 
              paste(c("~/Github/UpperPalCombinatorics/results/classifier/MLP/predictions300/predictions_MLP_",
                                              subcorpus1, "_",
                                              subcorpus2, "_",
...
write.csv(results.df, file = paste(c("~/Github/UpperPalCombinatorics/results/classifier/MLP/performance300/performance_MLP_",
                                              subcorpus1, "_",
                                              subcorpus2,
                                              ".csv"
                                              ), collapse = ""),
