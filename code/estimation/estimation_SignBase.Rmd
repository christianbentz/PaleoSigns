...
for (i in 1:nrow(sign.data)){
  ...
  # note: white spaces are generally counted as UTF-8 characters, and will hence impact the feature values.
  # For example, leaving white spaces around underscores will artificially decrease the unigram entropy.
