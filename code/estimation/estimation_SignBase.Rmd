...
Give head of estimation data frame (selected columns) for visual checking of the output data structure. Note that "coding_clean" gives the sequences with underscores and white spaces around them.
```{r}
