...
sign.data.selected <- select(sign.data, c('archaeological_unit', 'coding_clean', 
                                          ...
                                          'ttr.chars', 'rm.chars'))
# change column names
colnames(sign.data.selected) <- c('subcorpus', 'sequence', 'num.tokens', 'num.types', 
...
# select columns
teddi.selected <- select(teddi.data, c('subcorpus','text', 'num.tokens', 'num.types', 'huni.chars', 'hrate.chars', 
                           'ttr.chars', 'rm.chars'))
# rename column with sign sequences
