...
# select columns
nalafi.selected <- select(nalafi, c('subcorpus','num.char','huni.chars', 'hrate.chars', 
                           'ttr.chars', 'rm.chars'))
```
...
nalafi.selected <- nalafi.selected[nalafi$num.char == 100, ]

# combine the data frames
estimations.df <- rbind(sign.data.selected, procuneiV.data.selected, 
                        procuneiIV.data.selected, nalafi.selected)
nrow(estimations.df)
