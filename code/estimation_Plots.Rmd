...
# Load Data
Load csv file with quantitative feature values for sign sequences per object. Comparative sample: A comparative sample of feature values for languages across the world is dreived from the Text Data Diversity (TeDDi) sample (Moran et al 2022). 
```{r}
# SIGNBASE
